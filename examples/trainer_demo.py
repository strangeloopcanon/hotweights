...
from hotweights.adapters.trainer_swap import (
    swap_barrier,
    sota_in_place_swap as in_place_swap,
)
...
class Optim:
    def zero_grad(self, set_to_none: bool = True) -> None:  # noqa: ANN001
        pass
